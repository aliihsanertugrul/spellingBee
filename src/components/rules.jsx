...
const Rules = ({ handleTimer,t }) => {
  return (
    <div className=" w-3/4 bg-outerHoney rounded-xl p-8 text-sm md:text-lg">
      ...
      <button className="bg-zinc-700 hover:bg-zinc-800 transform duration-200 px-10 py-1 text-white rounded-md mt-5 animate-bounce" onClick={handleTimer}>
        {t.rules.play}
      </button>
      </div>
    </div>
